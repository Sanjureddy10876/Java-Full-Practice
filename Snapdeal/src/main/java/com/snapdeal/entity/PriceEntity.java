...
public class PriceEntity {
	...
	public PriceEntity(int priceID, int price, String currencyCode, String status, LocalDateTime createdDateandTime,
			LocalDateTime timestap, ProductEntity productEntity) {
		super();
