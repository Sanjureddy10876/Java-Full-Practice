...
public class SignupController {
	...
	@ResponseBody
	public String doRegister(@RequestParam("mobile") String mobile, @RequestParam("email") String email, @RequestParam("location") String location,@RequestParam("otp") String otp) {
